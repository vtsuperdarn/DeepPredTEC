...
@dask.delayed
def gen_npy_maps(cdate, inpDir, outDir, mlat_min=15.,
...
def generate_tec_map_files(sdate, edate=None, mlat_min=15.,
    ...
    for k, cdate in enumerate(cdates):
        outVals.append( gen_npy_maps(cdate, inpDir, outDir, mlat_min=mlat_min,
                           mlon_west=mlon_west, mlon_east=mlon_east) )
    total = dask.delayed(sum) (outVals)
    total.compute()
...
if __name__ == "__main__":
    ...
    inpDir = "/sd-data/med_filt_tec/"
    outDir="/home/sd-guest/Documents/data/dask/npy_dask/"    # Make sure you have this folder
    mlat_min = 15.
    mlon_west = 250
    mlon_east = 34
